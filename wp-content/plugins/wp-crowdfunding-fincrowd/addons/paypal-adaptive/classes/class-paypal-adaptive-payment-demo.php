...
class Paypal_Adaptive_Payment extends WC_Payment_Gateway
{
    ...
    public function __construct()
    {
        ...
        $this->method_description = sprintf('PayPal Adaptive Payment gateway is available in the %s Enterprise version %s', '<a href="https://wpneo.com/wp-crowdfunding" target="_blank">', '</a>' );
        $this->init_settings();
    }
}
