...
class WPNeo_Stripe_Connect extends WC_Payment_Gateway
{
    ...
    public function __construct(){
        ...
        $this->method_description = sprintf('WPNeo Stripe Connect gateway is available in the %s Enterprise version %s', '<a href="https://wpneo.com/wp-crowdfunding" target="_blank">', '</a>' );
