...
function neo_crowdfunding_go_premium(){
    ...
    $html .= '<iframe width="560" height="315" src="https://www.youtube.com/embed/6Y8eDiKXQw8" frameborder="0" allowfullscreen></iframe>';
    $html .= '<p>Try before you buy, here is the try <a href="http://try.wpneo.com/wp-crowdfunding/" target="_blank">demo</a>. WP Crowdfunding premium feature list.</p>';
    $html .= '<ul>';
    ...
    $html .= '<a target="_blank" href="https://wpneo.com/" class="wpneo-buynow">Buy WP Crowdfunding Premium Now >></a>';
    $html .= '</div>';
