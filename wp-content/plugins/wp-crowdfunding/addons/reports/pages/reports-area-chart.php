...
<div class="wrap campaign-warp">
    <a href="<?php echo admin_url( 'admin.php?page=wpneo-crowdfunding-reports&date_range=last_7_days' ); ?>" class="page-title-action"><?php _e('Last 7 days', 'wp-crowdfunding'); ?></a>
    <a href="<?php echo admin_url( 'admin.php?page=wpneo-crowdfunding-reports&date_range=this_month' ); ?>" class="page-title-action"><?php _e('This Month', 'wp-crowdfunding'); ?></a>
    <a href="<?php echo admin_url( 'admin.php?page=wpneo-crowdfunding-reports&date_range=last_month' ); ?>" class="page-title-action"><?php _e('Last Month', 'wp-crowdfunding'); ?></a>
    <a href="<?php echo admin_url( 'admin.php?page=wpneo-crowdfunding-reports&date_range=last_6_months' ); ?>" class="page-title-action"><?php _e('Last 6 Months', 'wp-crowdfunding'); ?></a>
    <a href="<?php echo admin_url( 'admin.php?page=wpneo-crowdfunding-reports&date_range=this_year' ); ?>" class="page-title-action"><?php _e('This Year', 'wp-crowdfunding'); ?></a>
    <a href="<?php echo admin_url( 'admin.php?page=wpneo-crowdfunding-reports&date_range=last_year' ); ?>" class="page-title-action"><?php _e('Last Year', 'wp-crowdfunding'); ?></a>
    ...
    <p class="alert alert-warning"><?php _e('Total Backers Amount : ', 'wp-crowdfunding'); ?>  <?php echo wc_price(array_sum($total_backers_amount_ever)); ?> </p>
</div>
