...
<ul id="bbp-forum-<?php bbp_forum_id(); ?>" <?php bbp_forum_class(); ?>>
	...
	<li class="bbp-forum-freshness">
		<div class="angin-center">
			<span class="bbp-topic-freshness-author"><?php bbp_author_link( array( 'post_id' => bbp_get_forum_last_active_id(), 'type' => 'avatar', 'size' => 50 ) ); ?></span>
			...
			<p class="bbp-topic-meta">
				...
				<span class="bbp-topic-freshness-link">
