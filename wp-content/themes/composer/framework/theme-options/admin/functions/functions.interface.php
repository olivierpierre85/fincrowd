...
function optionsframework_options_page(){
	...
	include_once( COMPOSER_ADMIN_PATH . 'front-end/options.php' );
...
function of_style_only(){
	...
	wp_register_style( 'pix-themeoptions', COMPOSER_ADMIN_DIR . 'assets/css/fonts.css', array(), '1.0', 'all' );
...
function of_ajax_callback() 
{
	...
	{
		of_save_options($options_machine->Defaults);
		composer_generate_options_css($options_machine->Defaults);
