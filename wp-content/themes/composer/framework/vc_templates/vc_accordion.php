...
$output = '
	<div class="pix_accordion ' . esc_attr( $css_class ) . ' ' . esc_attr( $style ) .'" data-collapsible="' . esc_attr( $collapsible ) . '" data-vc-disable-keydown="' . ( esc_attr( ( 'yes' === $disable_keyboard ? 'true' : 'false' ) ) ) . '" data-active-tab="' . $active_tab . '">
