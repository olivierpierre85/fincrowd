<?php
    class block7 extends blog_blocks {
        public function build_blog_post( $block = 'block7', $options = array(), $post_count, $total_post, $column_count ) {
            return $this->render( $block, $options, $post_count, $total_post, $column_count );
        }
        public function render( $block = 'block7', $options = array(), $post_count, $total_post, $column_count ) {
            ...
            switch ( $column ) {
                case 'col1':
                    ...
                    $output .= $this->blog_modules( 'module5', $options, $post_count );
