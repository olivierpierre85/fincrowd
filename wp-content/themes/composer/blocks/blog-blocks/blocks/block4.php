<?php
    class block4 extends blog_blocks {
        public function build_blog_post( $block = 'block4', $options = array(), $post_count, $total_post, $column_count ) {
            return $this->render( $block, $options, $post_count, $total_post, $column_count );
        }
        public function render( $block = 'block4', $options = array(), $post_count, $total_post, $column_count ) {
