<?php
    class block9 extends blog_blocks {
        public function build_blog_post( $block = 'block9', $options = array(), $post_count, $total_post, $column_count ) {
            return $this->render( $block, $options, $post_count, $total_post, $column_count );
        }
        public function render( $block = 'block9', $options = array(), $post_count, $total_post, $column_count ) {
            ...
            switch ( $column ) {
                case 'col1':
                    ...
                    $output .= $this->blog_modules( 'module7', $options, $post_count );
