<?php
    class block2 extends blog_blocks {
        public function build_blog_post( $block = 'block2', $options = array(), $post_count, $total_post, $column_count ) {
            return $this->render( $block, $options, $post_count, $total_post, $column_count );
        }
        public function render( $block = 'block2', $options = array(), $post_count, $total_post, $column_count ) {
            ...
            switch ( $column ) {
                case 'col1':
                    ...
                    if( $post_count == $first_col_open ) {
                        ...
                        $output .= $this->blog_modules( 'module2', $options, $post_count );
                    }
                    if( $post_count > 1 && $post_count <= $first_col_close  ) {
