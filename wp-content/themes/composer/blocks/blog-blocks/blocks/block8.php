<?php
    class block8 extends blog_blocks {
        public function build_blog_post( $block = 'block8', $options = array(), $post_count, $total_post, $column_count ) {
            return $this->render( $block, $options, $post_count, $total_post, $column_count );
        }
        public function render( $block = 'block8', $options = array(), $post_count, $total_post, $column_count ) {
            ...
            switch ( $column ) {
                case 'col1':
                    ...
                    if( $post_count == $first_col_open ) {
                        ...
                        $output .= $this->blog_modules( 'module6', $options, $post_count );
                    }
